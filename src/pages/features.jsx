...
const Features = () => {
  ...
  key={index}
  // whileHover={{ y: -10 }}
  whileTap={{ scale: 0.96 }} // 👈 mobile press feedback
  className="group relative p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md transition-all duration-300 overflow-hidden active:scale-95 cursor-pointer"
>
  {/* Glow Effect Layer */}
  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 group-active:opacity-100 transition duration-300">
  ...
  <div className="relative z-10 text-center">
    ...
    {/* Icon */}
    <div className="w-14 h-14 mx-auto mb-4 flex items-center justify-center rounded-full bg-red-600/20 text-red-500 
      group-hover:shadow-lg group-hover:shadow-red-500/40 
      group-active:shadow-lg group-active:shadow-red-500/40
      transition">
      {item.icon}
    </div>
