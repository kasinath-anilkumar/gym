        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-red-500 via-pink-500 to-red-500 opacity-0 group-hover:opacity-100 blur-sm transition duration-500"></div>
              ...
              <div className="relative bg-black/90 backdrop-blur-md rounded-2xl p-8 border border-white/10">
                ...
                {/* Popular Badge */}
                {plan.popular && (
                  <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-red-600 px-4 py-1 text-xs rounded-full">
                    Most Popular
                  </span>
                )}
                ...
                {/* Button */}
                <button className="w-full py-3 rounded-full font-semibold bg-red-600 hover:bg-red-700 transition shadow-lg shadow-red-900/40">
                  Join Now
                </button>
